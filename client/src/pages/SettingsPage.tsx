...
/* Save Result                                                        */
/* ------------------------------------------------------------------ */
function SaveResult({ result }: { result: SaveResultData }) {
...
/* Intro Textarea                                                     */
/* ------------------------------------------------------------------ */
function IntroTextarea({ label, hint, value, onChange, minHeight }: { label: string; hint: string; value: string; onChange: (v: string) => void; minHeight: number }) {
  return (
    <div className="mb-5">
