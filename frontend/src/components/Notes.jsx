...
export function NoteList({ notes, onRefresh }) {
...
export function NoteModal({ appId, onClose, onSaved }) {
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent>
        ...
        <div className="mb-5">
          <Label>Content</Label>
          <Textarea value={content} onChange={(e) => setContent(e.target.value)} placeholder="Write a note..." dir="auto" className="mt-1.5 min-h-[120px]" />
        </div>
        <DialogFooter>
