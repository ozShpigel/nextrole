...
function Panel({ label, body, empty }: PanelProps) {
...
export interface Snapshots {
  analystInput?: string | null;
  analystOutput?: string | null;
  evaluatorInput?: string | null;
...
export function SnapshotsModal({ title, snapshots, onClose }: SnapshotsModalProps) {
  return (
